...
<head>
  ...
  <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">SUPERCAFE</span></h1>
          <hr>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top " style="background-color: #000 !important;">    
    <div class="container " style="max-width: 1300px">
        <a class="navbar-brand text-white" href="user.php"> <img src="images/logomn.png" ><strong>  SUPER</strong> CAFE</a>
  ...
  <!-- Menu -->    
      ...
      <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">SUPERCAFE</h3>
          <h5>Jl. Dewa Ujung,Ciracas
          <br>Buka Jam <strong>11:00- 23:59</strong></h5>
        </div>
  ...
  <hr class="footer">
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> RPL 3</p>
          </div>
          </div>

          <div class="col-md-6 d-flex justify-content-end">
              <div class="icon-contact">
              <label class="font-weight-bold">Prestasi Prima</label>
             <a href="#"><img src="images/logo-smk.png"  data-toggle="tooltip" title="SMK"></a>
              </div>
          </div>
        </div>
